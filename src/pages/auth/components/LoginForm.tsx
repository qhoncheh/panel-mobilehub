...
const LoginForm = () => {
  ...
  return ( 
    <div className="flex justify-center items-center">
      <form className="flex flex-col items-center gap-4 p-6 text-right rounded-lg shadow-md w-full max-w-md">
        <Input
          label="ایمیل" 
          type="email"
        ...
        <button
          type="submit"
          className="w-full bg-[#BFF474] text-gray p-2 mt-4 font-bold rounded-3xl hover:bg-[#8AB054] transition"
        >   
          ورود
        </button>                           
      </form>
